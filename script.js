...
function hintButtonClick(){
  alert("The first song i've seen you sing + The first songs name which lyrics i gave you + my fav color + what phone do i use? + The answer from the last puzzle (no space and no capital letter in answer) ")
}
...
function checkColor() {
  ...
  if (inputValue === "srotoshinniporinitacyaninfinixiashtyctp") {
